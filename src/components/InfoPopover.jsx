              ...
              >
                  ...
                  <div className="p-4 space-y-3">
                    {items.map((item, i) => (
                      <div key={i} className="flex items-start gap-2.5">
                        <div className="w-1.5 h-1.5 rounded-full bg-amber-500 mt-1.5 flex-shrink-0 shadow-sm shadow-amber-200"></div>
                ...
                <div className="px-4 py-2 md:py-3 border-t border-gray-100 bg-white flex-none z-20">
                  <button
                    ...
                    className="w-full bg-amber-600 hover:bg-amber-700 text-white font-bold py-2 rounded-lg transition-all active:scale-[0.98] shadow-sm text-[11px] md:text-xs uppercase tracking-widest"
                  >
                    Close
                  </button>
                </div>
