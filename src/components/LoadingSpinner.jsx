  ...
  return (
    <div className={containerClasses}>
      <div className="relative">
        ...
        <div className="w-12 h-12 border-4 border-amber-600 border-dashed rounded-full animate-spin"></div>
        
        {/* Inner solid pulse (optional flair) */}
        <div className="absolute inset-2 bg-amber-100 rounded-full animate-pulse opacity-40"></div>
      </div>
