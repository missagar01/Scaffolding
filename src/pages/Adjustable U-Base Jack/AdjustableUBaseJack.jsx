...
import uHeadImg from '../../Assets/Products/Adjustable U-Head Jack.jpeg';
...
const AdjustableUBaseJack = () => {
  ...
  const uJackSizesTable = [
    { desc: "U-Head 450mm 30 Dia Solid Rod", uDim: "100 x 100 x 6mm", weight: "3.7 kg" },
    { desc: "U-Head 450mm 32 Dia Solid Rod", uDim: "100 x 100 x 6mm", weight: "4.0 kg" }
  ];
          ...
          <div className="flex flex-col mb-2">
            <div className="relative inline-block w-fit mb-1.5 pb-0.5">
              <h2 className="text-xl sm:text-2xl tracking-tight">
                ...
                <span className="text-[#1e293b] font-medium">U-Base Jack</span>
              </h2>
            ...
            <p className="text-[#475569] text-xs sm:text-sm leading-relaxed max-w-2xl">
              Sagar Adjustable U-Base Jacks (also known as U-Head Jacks or Stirrup Heads) are designed to hold steel beams and wooden battens at the top support zone of scaffolding or shuttering assemblies.
            </p>
          </div>
                    ...
                    <div className="w-full flex flex-col gap-1.5 mt-[-1.5vh]">
                      ...
                      <div className="bg-white border border-slate-200/80 rounded-lg p-2.5 shadow-xs w-full text-[10px] text-slate-600 space-y-1.5 mt-0.5">
                        <div className="flex justify-between border-b border-slate-100 pb-1">
                          ...
                          <span className="text-slate-900 font-medium">30 and 32 mm solid rod options</span>
                        </div>
                        <div className="flex justify-between border-b border-slate-100 pb-1">
                          <span className="font-semibold text-slate-700">U-Dimension:</span>
                          <span className="text-slate-900 font-medium">100 x 100 x 6 mm square flat channel</span>
                        </div>
                        <div className="flex justify-between border-b border-slate-100 pb-1">
                        ...
                        <div className="flex justify-between border-b border-slate-100 pb-1">
                          ...
                          <span className="text-slate-900 font-medium">Top level beam or channel placement</span>
                        </div>
                      ...
                      <div className="bg-white border border-slate-200/80 rounded-xl overflow-hidden shadow-sm w-full mt-1.5">
                        ...
                        <div className="p-3 text-[11px] sm:text-xs text-slate-600 grid grid-cols-2 gap-x-4 gap-y-2">
                          <div className="flex justify-between border-b border-slate-100 pb-1.5">
                            ...
                            <span className="text-slate-800 font-bold">30 and 32 mm solid rod options</span>
                          </div>
                          <div className="flex justify-between border-b border-slate-100 pb-1.5">
                            <span className="font-semibold text-slate-500">U-Dimension:</span>
                            <span className="text-slate-800 font-bold">100 x 100 x 6 mm square flat channel</span>
                          </div>
                          <div className="flex justify-between border-b border-slate-100 pb-1.5">
                          ...
                          <div className="flex justify-between border-b border-slate-100 pb-1.5">
                            ...
                            <span className="text-slate-800 font-bold">Top level beam or channel placement</span>
                          </div>
                  ...
                  {isMobile ? (
                      ...
                      <div className="bg-white border border-slate-200/80 rounded-lg overflow-hidden shadow-xs w-full mt-0.5">
                        <table className="cuplock-table-mobile w-full text-left border-collapse">
                          ...
                          <tbody className="text-[9.5px] text-slate-600 font-medium divide-y divide-slate-100">
                            {uJackSizesTable.map((row, i) => (
                              <tr key={i}>
                                <td className="py-0.5 px-2 font-bold">{row.desc}</td>
                                <td className="py-0.5 px-2">{row.uDim}</td>
                    ...
                    <div className="w-full flex flex-col gap-2.5">
                      ...
                      <div className="bg-white border border-slate-200/80 rounded-xl overflow-hidden shadow-sm w-full mt-1.5">
                        <div className="bg-[#8c1d21]/5 border-b border-slate-200/80 py-1.5 px-3">
                          <span className="text-[10px] sm:text-xs font-bold text-[#8c1d21] flex items-center gap-1">
                            <ClipboardList size={12} /> Adjustable U-Base Jack Weight Catalog
                          </span>
                        </div>
                          ...
                          <tbody className="text-[10px] sm:text-xs text-slate-600 font-medium divide-y divide-slate-100">
                            {uJackSizesTable.map((row, i) => (
                              <tr key={i} className="hover:bg-slate-50/50">
                                ...
                                <td className="py-1 px-3">{row.uDim}</td>
...
export default AdjustableUBaseJack;
