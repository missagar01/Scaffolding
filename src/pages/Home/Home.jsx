      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full max-w-4xl px-6 text-center -mt-16 sm:-mt-24 md:-mt-32">
        ...
        >
          <img
            ...
            className="w-[240px] sm:w-[300px] md:w-[350px] h-auto object-contain select-none pointer-events-none transition-all hover:scale-105 duration-300 filter drop-shadow-sm"
          />
        </motion.div>
