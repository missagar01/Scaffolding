                  ...
                  {isMobile ? (
                    ...
                    <div className="w-full flex flex-col gap-1.5 mt-[-1.5vh]">
                      <p className="text-slate-600 text-[10.5px] leading-relaxed">
                        ...
                        Manufactured using high-quality steel tubes conforming to <strong>IS 1239/1161 YST 210 Standard</strong>. Built for long-lasting structural support and reliable onsite scaffolding safety.
                      </p>
                      ...
                      <div className="bg-white border border-slate-200/80 rounded-lg p-2.5 shadow-xs w-full text-[10px] text-slate-600 space-y-1.5 mt-0.5">
                        <div className="flex justify-between border-b border-slate-100 pb-1">
                          <span className="font-semibold text-slate-700">Outer Tube Diameter:</span>
                          <span className="text-slate-900 font-medium">50NB (60.3 mm OD) medium class</span>
                        </div>
                        <div className="flex justify-between border-b border-slate-100 pb-1">
                          <span className="font-semibold text-slate-700">Inner Tube Diameter:</span>
                          <span className="text-slate-900 font-medium">40NB (48.3 mm OD) medium class</span>
                        </div>
                        <div className="flex justify-between border-b border-slate-100 pb-1">
                          <span className="font-semibold text-slate-700">Adjustment Pin:</span>
                          <span className="text-slate-900 font-medium">High tensile steel pin with chain</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="font-semibold text-slate-700">Thread System:</span>
                          <span className="text-[#8c1d21] font-bold">Double-start self-cleaning thread</span>
                        </div>
                      </div>
                      ...
                      <span className="text-[8px] text-slate-400 font-normal italic block">
                        ...
                        Tolerance +/- 3% on tube specifications.
                      </span>
                    </div>
                  ) : (
                  ...
                  {isMobile ? (
                    ...
                    <div className="w-full flex flex-col gap-1.5 mt-[-1.5vh]">
                      <p className="text-slate-600 text-[10.5px] leading-relaxed">
                        ...
                        Standard heights and approximate weights for Sagar Adjustable Props. Enables quick configuration selection based on staging requirements.
                      </p>
                        ...
                        <table className="cuplock-table-mobile w-full text-left border-collapse">
                          <thead>
                            <tr className="bg-slate-50 border-b border-slate-100 text-[8.5px] text-slate-500 font-semibold uppercase">
                              ...
                              <th className="py-0.5 px-2">Min Ht.</th>
                              <th className="py-0.5 px-2">Max Ht.</th>
                              <th className="py-0.5 px-2">Weight (approx)</th>
                            </tr>
                          </thead>
                          <tbody className="text-[9.5px] text-slate-600 font-medium divide-y divide-slate-100">
                            {propSizesTable.map((row, i) => (
                              <tr key={i}>
                                <td className="py-0.5 px-2 font-bold">{row.size}</td>
                      ...
                      <span className="text-[8px] text-slate-400 font-normal italic block">
                        <Info size={9} className="inline-block mr-1 align-middle shrink-0" />
                        Self-weight includes base, collar nut, and standard pin.
                      </span>
                    </div>
                  ) : (
